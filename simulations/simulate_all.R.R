...
### SLOBE 
obj_slobe_sigma_unknown <- SLOBEC( beta_lassoCV,Xmis,X.simPCA,Y,a_prior = 0.01*n, b_prior = .1*n,FDR=0.1, max_iter=100,BH=TRUE,verbose = F,known_sigma = F,known_cov = F)  
beta_slobe_sigma_unknown <- obj_slobe_sigma_unknown$beta

obj_slobe_sigma_lassoCV <- SLOBEC( beta_lassoCV,Xmis,X.simPCA,Y,a_prior = 0.01*n, b_prior = .1*n,FDR=0.1, max_iter=100,BH=TRUE,verbose = F,sigma = sigma_lassoCV,known_sigma = T,known_cov = F)  
beta_slobe_sigma_lassoCV <- obj_slobe_sigma_lassoCV$beta

obj_slobe_sigma_known <- SLOBEC( beta_lassoCV,Xmis,X.simPCA,Y,a_prior = 0.01*n, b_prior = .1*n,FDR=0.1, max_iter=100,BH=TRUE,verbose = F,sigma=1,known_sigma = T,known_cov = T,Covmat = sigma/n)  
beta_slobe_sigma_known <- obj_slobe_sigma_known$beta


### ABLASSO
obj_ablasso_sigma_unknown <- SLOBEC( beta_lassoCV,Xmis,X.simPCA,Y,a_prior = 0.01*n, b_prior = .1*n,FDR=0.1, max_iter=100,BH=F,verbose = F,known_sigma = F,known_cov = F)  
beta_ablasso_sigma_unknown <- obj_ablasso_sigma_unknown$beta

obj_ablasso_sigma_lassoCV <- SLOBEC( beta_lassoCV,Xmis,X.simPCA,Y,a_prior = 0.01*n, b_prior = .1*n,FDR=0.1, max_iter=100,BH=F,verbose = F,sigma = sigma_lassoCV,known_sigma = T,known_cov = F)  
beta_ablasso_sigma_lassoCV <- obj_ablasso_sigma_lassoCV$beta

obj_ablasso_sigma_known <- SLOBEC( beta_lassoCV,Xmis,X.simPCA,Y,a_prior = 0.01*n, b_prior = .1*n,FDR=0.1, max_iter=100,BH=F,verbose = F,sigma=1,known_sigma = T,known_cov = T,Covmat = sigma/n)  
